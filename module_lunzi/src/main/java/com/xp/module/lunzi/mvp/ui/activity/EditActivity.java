...
import com.xp.module.lunzi.di.component.DaggerEditComponent;
import com.xp.module.lunzi.mvp.contract.EditContract;
import com.xp.module.lunzi.mvp.presenter.EditPresenter;
...
public class EditActivity extends BaseActivity<EditPresenter> implements EditContract.View {
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.lun_activity_edit; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
