package com.xp.coms.dialog.dialogSig;
...
public final class HintDialog {
    ...
    public final static int ICON_FINISH = R.drawable.public_finish_ic;
    public final static int ICON_ERROR = R.drawable.public_error_ic;
    public final static int ICON_WARNING = R.drawable.public_warning_ic;
    ...
    public static final class Builder
        ...
        public Builder(Context context) {
            super(context);
            setContentView(R.layout.public_hint_dialog);
