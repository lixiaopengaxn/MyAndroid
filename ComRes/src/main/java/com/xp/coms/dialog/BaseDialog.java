...
import com.xp.coms.action.ActivityAction;
import com.xp.coms.action.AnimAction;
import com.xp.coms.action.ClickAction;
import com.xp.coms.action.HandlerAction;
import com.xp.coms.action.ResourcesAction;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    public BaseDialog(Context context) {
        this(context, R.style.public_base_dialog_style);
    }
    ...
    public static class Builder<B extends Builder> implements LifecycleOwner, ActivityAction, ResourcesAction, ClickAction {
        ...
        /** 主题样式 */
        private int mThemeId = R.style.public_base_dialog_style;
        /** 动画样式 */
