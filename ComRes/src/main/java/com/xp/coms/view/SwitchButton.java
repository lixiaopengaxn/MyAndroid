...
public final class SwitchButton extends View {
    ...
    public SwitchButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.public_SwitchButton);
        mChecked = array.getBoolean(R.styleable.public_SwitchButton_android_checked, mChecked);
        setEnabled(array.getBoolean(R.styleable.public_SwitchButton_android_enabled, isEnabled()));
