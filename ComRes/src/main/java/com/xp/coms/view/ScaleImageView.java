...
public final class ScaleImageView extends AppCompatImageView {
    ...
    public ScaleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.public_ScaleImageView);
        setScaleSize(array.getFloat(R.styleable.public_ScaleImageView_public_scaleRatio, mScaleSize));
        array.recycle();
    }
