...
public final class RatioFrameLayout extends FrameLayout {
    ...
    public RatioFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.public_RatioFrameLayout);
        mSizeRatio = array.getFloat(R.styleable.public_RatioFrameLayout_public_sizeRatio, 0);
        array.recycle();
    }
