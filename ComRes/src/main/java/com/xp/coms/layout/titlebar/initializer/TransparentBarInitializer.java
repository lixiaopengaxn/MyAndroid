package com.xp.coms.layout.titlebar.initializer;
...
import com.xp.coms.layout.titlebar.SelectorDrawable;
...
public class TransparentBarInitializer extends BaseBarInitializer {
    ...
    public Drawable getBackIcon(Context context) {
        return getDrawableResources(context, R.mipmap.public_ic_arrow_back_white_24dp);
    }
