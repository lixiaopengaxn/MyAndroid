...
public final class CustomViewStub extends FrameLayout {
    ...
    public CustomViewStub(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.public_CustomViewStub);
        mLayoutResource = array.getResourceId(R.styleable.public_CustomViewStub_android_layout, 0);
        array.recycle();
