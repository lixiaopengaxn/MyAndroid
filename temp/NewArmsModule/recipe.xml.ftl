...
<recipe>
    ...
    <mkdir at="${projectOut}/src/main/release" />
    <mkdir at="${projectOut}/src/main/debug" />
    ...
    <instantiate from="root/debug/AndroidManifest.xml.ftl"
                   to="${escapeXmlAttribute(manifestOut)}/debug/AndroidManifest.xml" />
    <instantiate from="root/release/AndroidManifest.xml.ftl"
