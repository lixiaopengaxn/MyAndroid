...
public interface RouterHub {
    ...
    String ELE = "/ele"; //电量组件
    String WAN = "/wan"; //玩android组件
    String LUNZI = "/lunzi"; //玩android组件
    ...
    //电量组件
    interface ELE_I{
        String ELE_SERVICE_ELEINFOSERVIEW = ELE + SERVICE + "/EleInfoService";
        String ELE_HOME_ACTIVITY = ELE + "/HomeActivity";
    }
    ...
    //玩Android 组件
    interface LUNZI_I{
        String LUNZI_SERVICE_ELEINFOSERVIEW = LUNZI + SERVICE + "/LunZiInfoService";
        String LUNZI_HOME_ACTIVITY = LUNZI + "/HomeActivity";
    }
