...
import com.xp.module.wan.di.component.DaggerForgotPasswordComponent;
import com.xp.module.wan.mvp.contract.ForgotPasswordContract;
import com.xp.module.wan.mvp.presenter.ForgotPasswordPresenter;
...
public class ForgotPasswordActivity extends BaseActivity<ForgotPasswordPresenter> implements ForgotPasswordContract.View {
    ...
    public void setupActivityComponent(@NonNull AppComponent appComponent) {
        DaggerForgotPasswordComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public int initView(@Nullable Bundle savedInstanceState) {
        return R.layout.wan_activity_forgot_password; //如果你不需要框架帮你设置 setContentView(id) 需要自行设置,请返回 0
    }
